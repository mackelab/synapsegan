"""Pipeline for experiments with Oja's Rule and small neural network."""
from tasks.abstract_factory import AbstractFactory as AF, _resume_from_checkpoint
...
class Factory(AF):
    """Factory for Oja's rule and small network pipeline."""
    ...
    def __init__(
        ...
        """Set up factory for Oja's rule and small network pipeline."""
